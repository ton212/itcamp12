                        ...
                        <div class="container-center">
                            ...
                            <ul class="camp">
                                <li id="content-camp-app">
                                    ...
                                    <p>เปิดโลกกว้างสุดสร้างสรรค์ ตะลุยไปในดินแดนความรู้แห่งแอพพลิเคชั่นกับ Applicationosaurus ค่ายที่จะพาน้องๆ ไปสัมผัสกับประสบการณ์การสร้างแอพพลิเคชั่นสุดเจ๋ง บนระบบปฏิบัติการ Windows 10 ในแบบที่ไม่เหมือนใคร ด้วยสุดยอดตัวช่วยอย่าง Microsoft Visual Studio 2015 แล้วน้องจะพบว่าการสร้างแอพพลิเคชั่นด้วยตัวเองไม่ใช่เรื่องยากอีกต่อไป มาเขียนแอพพลิเคชั่นกันเถอะ!</p>
                                    <p>สำหรับใครคิดว่ายังมีพื้นฐานไม่แน่นพอ ไม่ต้องกลัวไปนะครับ เพราะพวกพี่พร้อมที่จะสอนน้องๆ แบบจัดเต็ม ขอเพียงน้องมีความตั้งใจ กล้าคิดกล้าทำ แค่เท่านี้ก็เพียงพอแล้ว จะรอช้าอยู่ทำไมกดปุ่มสมัครเลย!</p>
                                ...
                                <li id="content-camp-game">
                                    ...
                                    <p>เบื่อมั้ย? กับเกมแบบเดิมๆ ที่เคยเล่น มาลองสร้างสรรค์ผลงานเกมในแบบของตัวเองในดินแดนแห่งนี้ไปกับ Game Maker Nodon ดูสิ จากผู้เล่นสู่ผู้สร้าง เส้นทางแห่งสายเกมเมอร์กำลังรอน้องๆ อยู่ มาปลดปล่อยจินตนาการไปบน Construct 2 ที่จะช่วยให้น้องสามารถสร้างเกมได้อย่างง่ายดายเพียงแค่ drag-and-drop ไม่ต้องเสียเวลามานั่งเขียนโค้ดให้เสียเวลา</p>
                                    <p>ได้ทั้งความรู้ด้านทฤษฎี แล้วยังลงมือปฏิบัติจริงอีก บอกเลยว่างานนี้ห้ามพลาด! ขอเพียงมีความคิดสร้างสรรค์ กล้าคิดริเริ่ม เท่านี้ความฝันของน้องๆ ก็อยู่ไม่ไกลเกินเอื้อมแล้ว</p>
                            ...
                            <ul class="camp">
                                <li id="content-camp-network">
                                    ...
                                    <p>ผจญภัยสุดมันส์ไปบนระบบเครือข่ายคอมพิวเตอร์กับ T-Rex Network ไปค้นหาความลับของการทำงานบนโครงสร้างที่ซับซ้อนเหล่านี้ว่าทำงานอย่างไร และน่าทึ่งขนาดไหน ซึ่งเป็นความรู้ที่นำมาจากจากวิชาที่เปิดสอนในคณะ โดยผ่านการเรียบเรียงให้กระชับ เข้าใจง่าย แม้แต่น้องๆ เองก็สามารถเรียนรู้ได้</p>
                                    <p>โดยภายในค่ายไม่เพียงแค่สอนทฤษฎี แต่ยังให้น้องๆ ได้ทดลองสร้างระบบจำลอง Internet บนโปรแกรม Packet Tracer พร้อมทั้งอุปกรณ์ที่ครบครัน บอกได้เลยว่าคุ้มค่ากับการมาเข้าร่วมแน่นอน อย่ารอช้าอยู่เลย...รีบสมัครเข้ามากันนะ!</p>
                                ...
                                <li id="content-camp-iot">
                                    ...
                                    <p>เมื่อยุคสมัยเริ่มเปลี่ยนไป เทคโนโลยีเริ่มก้าวหน้าขึ้น ทำให้เหล่าไดโนเสาร์ในดินแดนแห่งนี้ต้องพัฒนาเช่นกัน มาร่วมท่องไปบนดินแดนแห่งเทคโนโลยีล้ำสมัยที่พัฒนาขึ้นตามแนวคิด Internet of Things ที่จะเปลี่ยนโลกไปกับ IoT-Ceramus ที่จะพาน้องๆ ไปร่วมสร้างสรรค์ผลงานเทคโนโลยีอันทันสมัย และโดดเด่นกว่าใคร</p>
                                    <p>ซึ่งในค่ายนี้น้องยังจะได้มีโอกาสในการทดลองใช้งานเครื่องมือต่างๆ ไม่ว่าจะเป็น Arduino Uno R3, ESP8266 รวมถึงเครื่องมืออีกมากมาย โดยมีพี่ๆ คอยดูแลและสอนวิธีการใช้งาน รู้อย่างนี้แล้ว...ต้องสมัครแล้วล่ะ!</p>

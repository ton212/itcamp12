                ...
                <div class="background">
                    <div class="layer itcamp-description" data-addoffsety="0" data-scrollmodifier="0.72">
                        <div class="container-center">
                            ...
                            <hr />
                            <p class="textbox" style="font-size:26px;">ยินดีต้อนรับน้องๆ เหล่านักผจญภัยทั้งหลาย พร้อมที่จะไปผจญภัยกันหรือยัง? ที่นี่คือที่สำหรับรับสมัครนักผจญภัยที่จะมาร่วมเดินทางไปกับพวกพี่ในค่าย IT CAMP ครั้งที่ 12 จัดโดยคณะเทคโนโลยีสารสนเทศ สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง ซึ่งเป็นค่ายที่จะนำเหล่านักผจญภัยหรือน้องๆ ทั้ง 120 คน มาเรียนรู้เทคโนโลยีที่แปลกใหม่ไม่เหมือนใครตลอดระยะเวลา 4 วัน 3 คืน น้องๆ จะสามารถเลือกดินแดนที่จะเข้าร่วมเดินทางไปค้นหาและเก็บเกี่ยวความรู้ได้ ซึ่งมีด้วยกัน 4 ดินแดน แต่ละดินแดนก็จะมีไดโนเสาร์ประจำอยู่ ได้แก่ T-Rex Network, Applicationosaurus, Game Maker Nodon และ IoT-Ceramus โดยที่น้อง <u>จะต้องเลือกเพียงหนึ่งดินแดน</u> ที่สนใจเท่านั้น อย่ารอช้า! เริ่มรับสมัครตั้งแต่วันนี้ถึง 31 ตุลาคม 2558 นี้ แล้วเจอกันวันที่ 17 - 20 ธันวาคม 2558 นี้นะ</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="layer itcamp-sponsor" data-addoffsety="-270" data-scrollmodifier="0.65">
                        <div class="container-center">
                            ...
                            <div class="sponsor">
                                ...
                                <div class="spon-image large"><img src="main_assets/img/sponsor/ss_logo.png"></div>
                                <div class="breakimage"></div>
                        ...
                        <div class="container-center">
                            ...
                            <ul class="camp">
                                <li id="content-camp-app">
                                    ...
                                    <p style="font-size:23px;">เปิดโลกกว้างสุดสร้างสรรค์ ตะลุยไปในดินแดนความรู้แห่งแอพพลิเคชั่นกับ Applicationosaurus ค่ายที่จะพาน้องๆ ไปสัมผัสกับประสบการณ์การสร้างแอพพลิเคชั่นสุดเจ๋ง บนระบบปฏิบัติการ Windows 10 ในแบบที่ไม่เหมือนใคร ด้วยสุดยอดตัวช่วยอย่าง Microsoft Visual Studio 2015 แล้วน้องจะพบว่าการสร้างแอพพลิเคชั่นด้วยตัวเองไม่ใช่เรื่องยากอีกต่อไป มาเขียนแอพพลิเคชั่นกันเถอะ!</p>
                                    <p style="font-size:23px;">สำหรับใครคิดว่ายังมีพื้นฐานไม่แน่นพอ ไม่ต้องกลัวไปนะครับ เพราะพวกพี่พร้อมที่จะสอนน้องๆ แบบจัดเต็ม ขอเพียงน้องมีความตั้งใจ กล้าคิดกล้าทำ แค่เท่านี้ก็เพียงพอแล้ว จะรอช้าอยู่ทำไมกดปุ่มสมัครเลย!</p>
                                    <a class="button pill camp-app" href="/12/result/1"></a>
                                </li>
                                <li id="content-camp-game">
                                    <img src="main_assets/img/logo/gamemakernodon.png" />
                                    <p style="font-size:23px;">เบื่อมั้ย? กับเกมแบบเดิมๆ ที่เคยเล่น มาลองสร้างสรรค์ผลงานเกมในแบบของตัวเองในดินแดนแห่งนี้ไปกับ Game Maker Nodon ดูสิ จากผู้เล่นสู่ผู้สร้าง เส้นทางแห่งสายเกมเมอร์กำลังรอน้องๆ อยู่ มาปลดปล่อยจินตนาการไปบน Construct 2 ที่จะช่วยให้น้องสามารถสร้างเกมได้อย่างง่ายดายเพียงแค่ drag-and-drop ไม่ต้องเสียเวลามานั่งเขียนโค้ดให้เสียเวลา</p>
                                    <p style="font-size:23px;">ได้ทั้งความรู้ด้านทฤษฎี แล้วยังลงมือปฏิบัติจริงอีก บอกเลยว่างานนี้ห้ามพลาด! ขอเพียงมีความคิดสร้างสรรค์ กล้าคิดริเริ่ม เท่านี้ความฝันของน้องๆ ก็อยู่ไม่ไกลเกินเอื้อมแล้ว</p>
                                    <a class="button pill camp-game" href="/12/result/3"></a>
                                </li>
                            </ul>
                            <ul class="camp">
                                <li id="content-camp-network">
                                    <img src="main_assets/img/logo/trexnetwork.png" />
                                    <p style="font-size:23px;">ผจญภัยสุดมันส์ไปบนระบบเครือข่ายคอมพิวเตอร์กับ T-Rex Network ไปค้นหาความลับของการทำงานบนโครงสร้างที่ซับซ้อนเหล่านี้ว่าทำงานอย่างไร และน่าทึ่งขนาดไหน ซึ่งเป็นความรู้ที่นำมาจากจากวิชาที่เปิดสอนในคณะ โดยผ่านการเรียบเรียงให้กระชับ เข้าใจง่าย แม้แต่น้องๆ เองก็สามารถเรียนรู้ได้</p>
                                    <p style="font-size:23px;">โดยภายในค่ายไม่เพียงแค่สอนทฤษฎี แต่ยังให้น้องๆ ได้ทดลองสร้างระบบจำลอง Internet บนโปรแกรม Packet Tracer พร้อมทั้งอุปกรณ์ที่ครบครัน บอกได้เลยว่าคุ้มค่ากับการมาเข้าร่วมแน่นอน อย่ารอช้าอยู่เลย...รีบสมัครเข้ามากันนะ!</p>
                                    <a class="button pill camp-network" href="/12/result/2"></a>
                                </li>
                                <li id="content-camp-iot">
                                    <img src="main_assets/img/logo/iotceramus.png" />
                                    <p style="font-size:23px;">เมื่อยุคสมัยเริ่มเปลี่ยนไป เทคโนโลยีเริ่มก้าวหน้าขึ้น ทำให้เหล่าไดโนเสาร์ในดินแดนแห่งนี้ต้องพัฒนาเช่นกัน มาร่วมท่องไปบนดินแดนแห่งเทคโนโลยีล้ำสมัยที่พัฒนาขึ้นตามแนวคิด Internet of Things ที่จะเปลี่ยนโลกไปกับ IoT-Ceramus ที่จะพาน้องๆ ไปร่วมสร้างสรรค์ผลงานเทคโนโลยีอันทันสมัย และโดดเด่นกว่าใคร</p>
                                    <p style="font-size:23px;">ซึ่งในค่ายนี้น้องยังจะได้มีโอกาสในการทดลองใช้งานเครื่องมือต่างๆ ไม่ว่าจะเป็น Arduino Uno R3, ESP8266 รวมถึงเครื่องมืออีกมากมาย โดยมีพี่ๆ คอยดูแลและสอนวิธีการใช้งาน รู้อย่างนี้แล้ว...ต้องสมัครแล้วล่ะ!</p>
                                    <a class="button pill camp-iot" href="/12/result/4"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul class="profile">
                                ...
                                <li>
                                    ...
                                    <div class="profile-data">
                                        ...
                                        <p>เมื่อถึงเวลาที่ต้องเลือกเส้นทางอนาคต แต่ยังไม่รู้จะเลือกอะไร น้องๆ อาจจะกำลังสับสน เพราะพี่ก็เคยเป็นเช่นเดียวกัน เคยรู้สึกเสียดายที่ไม่เคยเข้าค่ายไอทีแคมป์มาก่อน แต่เมื่อได้มาเป็นคนจัดจึงได้รู้ว่าค่ายนี้ให้น้องทุกคนที่เข้าร่วมได้เห็นทางเลือกที่ใช่ จากบรรยากาศที่น้องจะได้สัมผัสความรู้ ทักษะด้านไอที และความสนุกที่เป็นเอกลักษณ์ของที่นี้ และพี่หวังเป็นอย่างยิ่งว่า น้องๆ จะเปิดใจที่จะค้นหาสิ่งใหม่ๆ สิ่งที่น้องอาจจะยังไม่แน่ใจ หรือยังไม่เคยเจอมาก่อน อย่าติดอยู่ในโลกแห่งความคิดเดิมๆ เพราะพี่ๆ ค่ายนี้รอที่ให้คำตอบน้องอยู่ ขอเพียงมาสัมผัสเท่านั้น และสุดท้ายที่พี่อยากบอกคือเราสามารถเลือกได้เสมอ แต่เวลาที่ให้เลือกไม่ได้มีตลอด ดังนั้นเมื่อมีโอกาส ขอให้เลือก “ไอทีแคมป์” แล้วจะได้ไม่เสียดายที่ไม่ได้เข้าเหมือนพี่ จากใจคนที่ผ่าน ม.ปลาย มาก่อนแล้วตอนนี้อยู่มหาลัย</p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="profile-data">
                                        ...
                                        <p>IT CAMP เป็นค่ายแรกและค่ายเดียวที่พี่เคยเข้าร่วมในชีวิต ม.ปลาย พี่ขอบอกว่าเป็นค่ายที่สนุกและได้รับความรู้ ความประทับใจมาก จนทำให้พี่ไม่สนใจคณะไหนอีกเลยนอกจากที่นี่ ซึ่งหากน้องได้เข้าร่วม น้องจะได้รับความรู้ด้านวิชาการจากค่ายย่อยตามที่น้องสนใจ แต่นอกจากน้องจะได้ความรู้กลับไปแล้ว น้องยังจะได้ความสนุกสนาน ความเพลิดเพลินที่พี่เตรียมไว้ให้ตลอด 4 วัน 3 คืน ของค่ายนี้ และสุดท้ายที่น้องจะได้จากค่ายนี้มิตรภาพที่ดีจากพี่ๆ และเพื่อนใหม่ที่หาไม่ได้จากที่ไหนอีกแล้ว</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="box">
                                <div class="box-timeline">
                                    ...
                                    <div class="timeline-description">
                                        ...
                                        <span class="announce">6 พฤศจิกายน 58<br />ประกาศผลและโอนเงินยืนยันสิทธิ์</span>
                                        <span class="lastconday">21 พฤศจิกายน 58<br />วันสุดท้ายของการยืนยันสิทธิ์</span>
                                ...
                                <div class="box-contact">
                                    <div class="box-faq">
                                        ...
                                        <ul>
                                            ...
                                            <li>A: มีค่าใช้จ่าย จำนวน 500 บาท โดยชำระตามเวลาที่กำหนด (6 - 21 พฤศจิกายน 2558) หากน้องคนใดจะสละสิทธิ์ สามารถกดปุ่มสละสิทธิ์ที่หน้าเว็บและขอให้น้องๆ คิดให้รอบคอบก่อนจะชำระเงิน เพราะหากน้องสละสิทธิ์จะไม่ได้รับเงินคืนครับ และหากโอนเงินไม่ทันภายในวันที่กำหนดจะถือว่าสละสิทธิ์นะครับ</li>
                                            ...
                                            <li>Q: ค่าย IoT คืออะไร ?</li>
                                            <li>A: IoT (Internet of things)  คือเทคโนโลยีที่เชื่อมทุกสิ่งทุกอย่างเข้าด้วยกันบนโลกอินเทอร์เน็ต ทำให้มนุษย์สามารถสั่งการ ควบคุมใช้งาน อุปกรณ์ต่างๆ ผ่านทางเครือข่ายอินเทอร์เน็ตได้
ตัวอย่างเช่น หากเราอยู่นอกบ้านแล้วอยากต้มน้ำร้อน เราไม่สามารถทำได้ แต่หากกาต้มน้ำเป็น IoT นั่นคือสามารถสั่งการควบคุมกาต้มน้ำผ่านอินเทอร์เน็ตได้ เช่น อุณหภูมิ เราก็สามารถสั่งให้กาต้มน้ำเพิ่มอุณหภูมิผ่านโทรศัพท์มือถือเพื่อทำให้น้ำเดือดได้
หรือกล่าวง่ายๆ IoT ก็คือการควบคุมอุปกรณ์ไฟฟ้าต่างๆ ผ่านอินเทอร์เน็ต หรือ อุปกรณ์ที่สามารถเชื่อมต่อผ่านอินเทอร์เน็ตได้ โดยในค่าย IoT น้องๆ จะได้ลองเขียนโปรแกรมควบคุมอุปกรณ์เหล่านี้โดยเชื่อมต่อผ่านอินเทอร์เน็ตกัน</li>
                                        </ul>
                                    </div>
                                    <h2>ติดต่อ</h2>

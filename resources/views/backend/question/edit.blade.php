					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<select name="score_scale" class="form-control" data-placeholder="เลือกเกณฑ์การให้คะแนน">
								<option></option>
								<option @if($question->score_scale == [-1, 0, 1]) selected @endif>-1, 0, 1</option>
								<option @if($question->score_scale == [-2, -1, 0, 1, 2]) selected @endif>-2, -1, 0, 1, 2</option>
								<option @if($question->score_scale == [0, 1]) selected @endif>0, 1</option>
								<option @if($question->score_scale == [0, 1, 2, 3]) selected @endif>0, 1, 2, 3</option>
								<option @if($question->score_scale == [0, 1, 2, 3, 4]) selected @endif>0, 1, 2, 3, 4</option>
								<option @if($question->score_scale == [0, 1, 2, 3, 4, 5]) selected @endif>0, 1, 2, 3, 4, 5</option>
							</select>
						</div>
						<div class="row">
							<div class="col-md-10">

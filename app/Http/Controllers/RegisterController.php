...
class RegisterController extends Controller {
	...
	protected $validator_msg = [
		...
		'id_card.digits' => 'รหัสประจำตัวประชาชน ต้องยาว 13 ตัวนะครับ',
		'id_card.numeric' => 'รหัสประจำตัวประชาชน ต้องเป็นตัวเลขเท่านั้นนะครับ',
		'address.postcode.numeric' => 'รหัสไปรษณีย์ ต้องเป็นตัวเลขเท่านั้นนะครับ',
		'address.tel.numeric' => 'เบอร์โทรศัพท์ ต้องเป็นตัวเลขเท่านั้นนะครับ',
		'parent.addr.postcode.numeric' => 'รหัสไปรษณีย์ (ส่วนของ ที่อยู่ผู้ปกครอง) ต้องเป็นตัวเลขเท่านั้นนะครับ',
		'parent.tel.0.numeric' => 'เบอร์โทรศัพท์ผู้ปกครอง ต้องเป็นตัวเลขเท่านั้นนะครับ',
		'parent.tel.1.numeric'  => 'เบอร์โทรศัพท์ผู้ปกครอง ลำดับที่ 2 ต้องเป็นตัวเลขเท่านั้นนะครับ',
		'address.village_no.numeric' => 'หมู่ ต้องเป็นตัวเลขเท่านั้นนะครับ',
		'parent.addr.village_no.numeric' => 'หมู่ (ส่วนของ ที่อยู่ผู้ปกครอง) ต้องเป็นตัวเลขเท่านั้นนะครับ',
	];
	...
	public function store(Request $request)
	{
		$rules = [
			...
			'parent.addr.village_no'	=> 'numeric',
			'parent.addr.street'       => 'required',
			'parent.addr.sub_district' => 'required',
			'parent.addr.district'     => 'required',
			'parent.addr.province'     => 'required',
			'parent.addr.postcode'     => 'required|numeric',
			'parent.tel.0'                => 'required|numeric',
			'parent.tel.1'                => 'required|numeric',
			'shirt_size'                 => 'required',
		];
